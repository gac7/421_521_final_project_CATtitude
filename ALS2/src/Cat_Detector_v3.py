...
while True:
	...
	##The next 10 lines of code one again from Cat-fancier
	args = parsearguments()
	...
	os.remove('../../imgdrop/img' + str(k) + '.png') #All done with this file. If there was a cat, it's in the guilt CATalog. If not, OK to deleter
	k = k+1
